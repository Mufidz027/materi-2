...
<html lang="en">
  ...
  <head>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <h2>Best <em>Riding equipment store</em> in town</h2>
   ...
   <!-- ***** Cars Starts ***** -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="assets/images/pe.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                                <del><sup>$</sup>15.00</del> <sup>$</sup>10.00
                            ...
                            <h4>perlengkapan riding fullset.</h4>
    ...
    <section class="section section-bg" id="schedule" style="background-image: url(assets/images/4.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
    ...
    <section class="section section-bg" id="call-to-action" style="background-image: url(99.jpeg)">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="assets/images/medium.jpg" alt="waves">
