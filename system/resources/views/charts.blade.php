...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html" class="img-responsive logo">Rider Website</a>
			</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="charts" class="active"><i class="lnr lnr-chart-bars"></i> <span>kategori</span></a></li>
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="index" class="">ride</a></li>
								</ul>
							</div>
						</li>
			...
			<div class="main-content">
				<div class="panel panel-headline">
						<div class="panel-heading">
							<h2>ini halaman kategori</h2>
							<h3 class="panel-title">produk sedang habis, tunggu lah beberapa tahun lagi</h3>
